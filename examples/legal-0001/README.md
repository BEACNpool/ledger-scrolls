...
Pull it like a court record — type the number into the public terminal:
**[`legal.html#doc=1`](https://beacnpool.github.io/ledger-scrolls/legal.html#doc=1)** —
which compiles a Certificate of Record from ledger data and renders the
instrument only after the seal verifies. The terminal works for any docket
via `#docket=<policy-id>`.
